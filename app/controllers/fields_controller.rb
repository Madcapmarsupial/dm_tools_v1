class FieldsController < ApplicationController
  ...
  # # end
   ...
   def field_params
     params.require(:field).permit(:type, :description, :name, :options, :completion, 
        component_attributes: [:id, :type, :description, :name, :quantity, :alignment, :completion]
    ) #setting_id, objective_id 
   end
